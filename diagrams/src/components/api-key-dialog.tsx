          ...
          <details className="group text-sm [&>summary:focus-visible]:outline-none">
            ...
            <div className="animate-accordion-down mt-2 space-y-2 overflow-hidden pl-2">
              <p className="text-stone-600">
                {isLoggedIn
                  ? "Your API key is encrypted with AES-256-GCM before being stored in the database. Only you can access it through your authenticated session."
                  : "Your API key will be stored locally in your browser and used only for generating diagrams."}{" "}
